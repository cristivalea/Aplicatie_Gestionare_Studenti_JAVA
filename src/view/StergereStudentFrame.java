...
public class StergereStudentFrame extends JFrame implements ActionListener{
    ...
    public StergereStudentFrame(){
        ...
        this.panelCautare.setBorder(BorderFactory.createTitledBorder(
                ...
                "Cautarea Studentului dupa nume",                   // Textul titlului
        ...
        this.labelNumeText = new JLabel("Introduceti numele studentului ");
    ...
    public static void main(String[] argc){
        StergereStudentFrame obj = new StergereStudentFrame();
    }
    @Override
